...
/*
    ...
    void rotate_around(const Vector3 point,const Quaternion quaternion) override = 0;
    void translate(const Vector3 arg) override = 0;
    void destroy() override = 0;
    DistanceEstimator *get_distance_estimator() const override = 0;
